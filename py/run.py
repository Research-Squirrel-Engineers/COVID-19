...
prefixes = "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \r\nPREFIX owl: <http://www.w3.org/2002/07/owl#> \r\nPREFIX xsd: <http://www.w3.org/2001/XMLSchema#> \r\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \r\nPREFIX dc: <http://purl.org/dc/elements/1.1/> \r\nPREFIX covid19: <http://covid19.squirrel.link/ontology#> \r\nPREFIX world: <http://world.squirrel.link/ontology#> \r\n\r\n";
file.write(prefixes)
file.write("covid19:COVID19_DataRKICUM rdf:type rdfs:Resource .\r\n")
file.write("covid19:COVID19_DataRKICUM rdf:type covid19:Dataset .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:created '2020-04-05T10:53:21.259+0100' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:modified '" + datetime.datetime.now().strftime("%Y-%m-%dT%H:%M:%S.000+0100") + "' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:creator 'Florian Thiery' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:contributor 'Timo Homburg' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:language 'en' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:type 'ontology' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:title 'COVID-19 data by RKI' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:subject 'COVID-19' .\r\n")
file.write("covid19:COVID19_DataRKICUM dc:rights 'CC BY 4.0' .\r\n\r\n")
for line in lines3:
    file.write(line)
    file.write("\r\n")
file.close()
